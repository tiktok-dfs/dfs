...
type ProxyService struct {
	*ProtoService
	ECAssignDataNode func(context.Context, *namenode_pb.ECAssignDataNodeReq) (*namenode_pb.ECAssignDataNodeResp, error)
	GetBlockSize     func(context.Context, *namenode_pb.GetBlockSizeRequest) (*namenode_pb.GetBlockSizeResponse, error)
	ReadData         func(context.Context, *namenode_pb.ReadRequst) (*namenode_pb.ReadResponse, error)
	WriteData        func(context.Context, *namenode_pb.WriteRequest) (*namenode_pb.WriteResponse, error)
	DeleteData       func(context.Context, *namenode_pb.DeleteDataReq) (*namenode_pb.DeleteDataResp, error)
	StatData         func(context.Context, *namenode_pb.StatDataReq) (*namenode_pb.StatDataResp, error)
	GetDataNodes     func(context.Context, *namenode_pb.GetDataNodesReq) (*namenode_pb.GetDataNodesResp, error)
	IsDir            func(context.Context, *namenode_pb.IsDirReq) (*namenode_pb.IsDirResp, error)
	Rename           func(context.Context, *namenode_pb.RenameReq) (*namenode_pb.RenameResp, error)
	Mkdir            func(context.Context, *namenode_pb.MkdirReq) (*namenode_pb.MkdirResp, error)
	List             func(context.Context, *namenode_pb.ListReq) (*namenode_pb.ListResp, error)
	ReDirTree        func(context.Context, *namenode_pb.ReDirTreeReq) (*namenode_pb.ReDirTreeResp, error)
	HeartBeat        func(context.Context, *namenode_pb.HeartBeatReq) (*namenode_pb.HeartBeatResp, error)

	RegisterDataNode1     func(context.Context, *namenode_pb.RegisterDataNodeReq) (*namenode_pb.RegisterDataNodeResp, error)
	RegisterDataNode      func(req namenode_pb.NameNodeService_RegisterDataNodeServer) error
	JoinCluster           func(context.Context, *namenode_pb.JoinClusterReq) (*namenode_pb.JoinClusterResp, error)
	FindLeader            func(context.Context, *namenode_pb.FindLeaderReq) (*namenode_pb.FindLeaderResp, error)
	UpdateDataNodeMessage func(context.Context, *namenode_pb.UpdateDataNodeMessageReq) (*namenode_pb.UpdateDataNodeMessageResp, error)
}

var methodTransactionInfo = make(map[string]*model.TransactionInfo)

func init() {
	methodTransactionInfo["ECAssignDataNode"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "ECAssignDataNode",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["GetBlockSize"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "GetBlockSize",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["ReadData"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "ReadData",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["WriteData"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "WriteData",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["DeleteData"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "DeleteData",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["StatData"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "StatData",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["GetDataNodes"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "GetDataNodes",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["IsDir"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "IsDir",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["Rename"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "Rename",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["Mkdir"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "Mkdir",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["List"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "List",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["ReDirTree"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "ReDirTree",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["HeartBeat"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "HeartBeat",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["RegisterDataNode1"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "RegisterDataNode1",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["JoinCluster"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "JoinCluster",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["FindLeader"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "FindLeader",
		Propagation: model.REQUIRED,
	}
	methodTransactionInfo["UpdateDataNodeMessage"] = &model.TransactionInfo{
		TimeOut:     300000,
		Name:        "UpdateDataNodeMessage",
		Propagation: model.REQUIRED,
	}
}

func (svc *ProxyService) GetProxyService() interface{} {
	return svc.ProtoService
}
...
/*func (s *ProtoService) RegisterDataNode(c context.Context, req *namenode_pb.RegisterDataNodeReq) (*namenode_pb.RegisterDataNodeResp, error) {
...
func (s *ProtoService) RegisterDataNode(req namenode_pb.NameNodeService_RegisterDataNodeServer) error {
	recv, err := req.Recv()
	if err != nil {
		return err
	}
	...
	s.DataNodeHeartBeat[recv.Addr] = time.Now()
	return nil
}

func (s *ProtoService) HeartBeat(c context.Context, req *namenode_pb.HeartBeatReq) (*namenode_pb.HeartBeatResp, error) {
...
func (s *ProtoService) ReDirTree(c context.Context, req *namenode_pb.ReDirTreeReq) (*namenode_pb.ReDirTreeResp, error) {
...
func (s *ProtoService) List(c context.Context, req *namenode_pb.ListReq) (*namenode_pb.ListResp, error) {
...
func (s *ProtoService) Mkdir(c context.Context, req *namenode_pb.MkdirReq) (*namenode_pb.MkdirResp, error) {
...
func (s *ProtoService) Rename(c context.Context, req *namenode_pb.RenameReq) (*namenode_pb.RenameResp, error) {
...
func (s *ProtoService) IsDir(c context.Context, req *namenode_pb.IsDirReq) (*namenode_pb.IsDirResp, error) {
...
func (s *ProtoService) GetDataNodes(c context.Context, req *namenode_pb.GetDataNodesReq) (*namenode_pb.GetDataNodesResp, error) {
	var list []string
...
func (s *ProtoService) StatData(c context.Context, req *namenode_pb.StatDataReq) (*namenode_pb.StatDataResp, error) {
...
func (s *ProtoService) DeleteData(c context.Context, req *namenode_pb.DeleteDataReq) (*namenode_pb.DeleteDataResp, error) {
...
func (nameNode *ProtoService) ReDistributeData(request *ReDistributeDataRequest, reply *bool) error {
...
func (nameNode *ProtoService) assignDataNodes(blockId string, dataNodesAvailable []int64, replicationFactor uint64) []int64 {
...
func (nameNode *ProtoService) allocateBlocks(fileName string, numberOfBlocks uint64) (metadata []NameNodeMetaData) {
	//创建写入文件的 slot
...
func (nn *ProtoService) WriteData(ctx context.Context, req *namenode_pb.WriteRequest) (*namenode_pb.WriteResponse, error) {
	modedFilePath := util.ModFilePath(req.FileName)
	// 不允许重复写
...
func (nn *ProtoService) ReadData(ctx context.Context, req *namenode_pb.ReadRequst) (*namenode_pb.ReadResponse, error) {
	modedFilePath := util.ModFilePath(req.FileName)
...
func (nn *ProtoService) GetBlockSize(ctx context.Context, req *namenode_pb.GetBlockSizeRequest) (*namenode_pb.GetBlockSizeResponse, error) {
...
func (nameNode *ProtoService) SelectRandomDataNodes(availableDataNodes []int64, replicationFactor uint64) (randomSeletctedDataNodes []int64) {
...
func (s *ProtoService) UpdateDataNodeMessage(c context.Context, req *namenode_pb.UpdateDataNodeMessageReq) (*namenode_pb.UpdateDataNodeMessageResp, error) {
	s.DataNodeMessageMap[req.Addr] = DataNodeMessage{
		UsedDisk:   req.UsedDisk,
		UsedMem:    req.UsedMem,
		TotalMem:   req.TotalMem,
...
func (s *ProtoService) ECAssignDataNode(c context.Context, req *namenode_pb.ECAssignDataNodeReq) (*namenode_pb.ECAssignDataNodeResp, error) {
